...
let changeColor = (object:product, newColor:string)=>{
    ...
    if(object.color === "white"){
        let increaseper10: number = object.price/ 100 * 10
        object.price += increaseper10
    }
    else if (object.color === "blue"){
        let increaseper5:number = object.price / 100 * 5
    }
    else if (object.color === "black"){
        let decreaseper10:number = object.price/100 *10
...
function item(value: product, index: number, array: product[]): void {
